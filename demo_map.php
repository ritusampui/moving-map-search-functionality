...
<html lang="en">
  <head>
    ...
    <link href="new_css_js/css/starter-template.css" rel="stylesheet">
	<link href="new_css_js/css/ms-style.css" rel="stylesheet">
  ...
  <body>
	...
	<script type="text/javascript" src="new_css_js/js/jquery.mapSearch.min.js"></script>
	<script>
		(function ( $ ) {
