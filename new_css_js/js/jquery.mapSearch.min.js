! function(e) {
    e.fn.mapSearch = function(t) {
        ...
        function a(t) {
            "" != d.request_uri && (e(m).addClass(d.loading_class), e(d.listings_el).addClass(d.loading_class), e.get(d.request_uri + "?" + e.param(e.extend(_, t)), function(t) {
                p(), e(d.listings_el).empty(), e.each(t[d.results_key], function(e, t) {
                    u(e, t), s(e, t)
                }), e(d.pagination_el).empty().prepend(g(d.page_number(t))), e("." + d.pagi_link_class).click(function() {
                    b.page = e(this).data("href"), e.fn.mapSearch.update(b)
                }), d.marker_clusterer && "function" == typeof MarkerClusterer ? (f.clearMarkers(), f.addMarkers(w)) : l(), e(m).removeClass(d.loading_class), e(d.listings_el).removeClass(d.loading_class)
            }))
        }

        function o(e, t) {
            google.maps.event.addListener(t, "click", function() {
                C.setContent(e), C.open(v, t)
            })
        }
        ...
        function g(t) {
            var n = t > 1 ? '<li><a href="#" class="' + d.pagi_link_class + '" data-href="' + (t - 1) + '">' + d.prev_btn_text + "</a></li>" : "",
                a = '<li><a href="#" class="' + d.pagi_link_class + '" data-href="' + (t + 1) + '">' + d.next_btn_text + "</a></li>";
            return e(n + a).wrapAll("<ul></ul>").parent().addClass("pagination")
        }
        ...
        function u(t, n) {
            var a = e(e.parseHTML(d.listing_template(n))).wrap(d.listing_wrapper).parent().attr("data-mid", t).addClass(d.listing_class).mouseenter(function() {
                var t = e(this).attr("data-mid");
                e.each(w, function(e, n) {
                    Number(n.get("mid")) === Number(t) && n.setIcon(d.highlighted_icon)
                })
            }).mouseleave(function() {
                var t = e(this).attr("data-mid");
                e.each(w, function(e, n) {
                    Number(n.get("mid")) === Number(t) && n.setIcon(d.icon)
                })
            });
        ...
        if (m = this[0], d = e.extend({
            ...
            if ("object" == typeof google.maps.places) {
                ...
                e("#search-form").addClass(d.searchbox_class).prop("placeholder", d.searchbox_placeholder), v.controls[google.maps.ControlPosition.TOP_CENTER].push(x);
